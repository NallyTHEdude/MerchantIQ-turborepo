...
export function MerchantSummaryCards({
    ...
    const stats = [
        ...
        },
        {
            ...
            value: pending,
            subtext:
                pending > 0 ? `${pending} requires action` : 'All caught up',
        ...
        },
        {
            ...
            subtext:
                total > 0
                    ? `${Math.round((completed / total) * 100)}% verification rate`
            ...
            {stats.map((stat) => {
                ...
                return (
                    ...
                    >
                        ...
                        <p
                            className={`text-xs mt-2 font-medium ${stat.subtextColor}`}
                        >
                            {stat.subtext}
                        </p>
                    </div>
