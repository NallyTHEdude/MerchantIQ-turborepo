...
export function PaymentMethodChart({
    ...
    const aggregated = payments.reduce<
        ...
        >
            <CardHeader className="flex flex-row items-center justify-between pb-3">
                ...
                <span className="text-xs text-slate-400 font-medium">
                    ...
                    {chartData.length === 1 ? 'method' : 'methods'}
                </span>
            </CardHeader>
                    ...
                    <div className="h-60 flex items-center justify-center">
                        <div className="animate-pulse flex flex-col items-center gap-2">
                            ...
                            <span className="text-xs text-slate-400">
                                Aggregating payment distribution...
                            </span>
                        </div>
                    </div>
                ) : chartData.length === 0 ? (
                        ...
                        <div className="grid grid-cols-3 gap-3 pt-3 border-t border-slate-100">
                            {chartData.map((item) => (
                                <div key={item.method} className="min-w-0">
                                    ...
                                    <div className="text-slate-500 font-mono text-[10px] leading-tight pl-4">
                                        {item.count} txns
                                    </div>

                                    <div className="text-slate-400 font-mono text-[10px] leading-tight pl-4 truncate">
