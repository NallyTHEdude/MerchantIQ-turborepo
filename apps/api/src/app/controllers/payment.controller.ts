...
export const getAllPayments = asyncHandler(
    async (req: Request<PaymentMerchantIdParam>, res: Response) => {
...
export const getPaymentById = asyncHandler(
    async (
        req: Request<PaymentMerchantIdParam & PaymentIdParam>,
        res: Response,
    ) => {
...
export const createPayments = asyncHandler(
    async (req: CreatePaymentRequest, res: Response) => {
        const { merchantId } = req.params;
